...
<!-- Mirrored from designreset.com/cork/ltr/demo4/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Jul 2021 10:08:56 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="form-container">
                <div class="form-content">
                    ...
                    <p class="">Log in to your account to continue.</p>
                        ...
                        {{ Form::open(['route' => 'admin.login', 'method' => 'POST', 'class' => ['text-left']]) }}
                        <div class="form">
